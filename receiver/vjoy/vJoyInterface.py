...
class vJoyInterface(object):
    ...
    if p.architecture()[0]=='32bit':
        print '32bit architecture'
        dllfile = 'vJoyInterface32.dll'
    else:
        print "64bit architecture"
        dllfile = 'vJoyInterface64.dll'
  
    vJoyInterface_dll = ctypes.cdll.LoadLibrary(os.path.join(os.path.dirname(__file__), dllfile))
    ...
    functions = {
        ...
        'GetVJDAxisExist' : {'arguments' : [ctypes.c_uint, ctypes.c_int], 'returns' : ctypes.c_int},
